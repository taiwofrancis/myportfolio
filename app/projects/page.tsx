...
const projects = [
  ...
  {
    id: 'epique',
    title: 'Epique Realty WebApp',
    description: 'Collaborated in developing and maintaining Epique Realty’s real estate website, supporting responsive UI improvements, performance updates, and seamless user experience across devices.',
    image: '/epique.png',
    imageGradient: 'from-indigo-500 to-purple-600',
    tags: ['OpenAI', 'React', 'Software Architecture', 'GUI'],
    category: 'Full-Stack',
    status: 'Completed',
    timeline: '1 month',
    year: '2024',
  ...
  {
    id: 'sharpe',
    title: 'Sharpe Arbitrage Screener',
    description: 'Collaborated on building and deploying Sharpe.ai’s Perp Arbitrage Screener**, a full-stack web app that aggregates real-time perp market data, detects arbitrage spreads, and displays actionable trading opportunities in a clean dashboard UI.',
    image: "/sharpe.png",
    imageGradient: 'from-emerald-500 to-teal-600',
    tags: ['RestFul API', 'PostgreSQL', 'React.js', 'API Development', 'Docker', 'IBM Cloud'],
    category: 'Full-Stack',
    status: 'Completed',
    timeline: '2 month',
    year: '2024',
    client: 'Freelance Project',
    featured: true,
    links: [{ type: 'freelancer', url: 'https://sharpe.ai/arbitrage/perp-screener' }],
  },
]
